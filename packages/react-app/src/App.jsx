...
function App(props) {
  ...
  /*
  const ans = useContractReader(readContracts, "YourContract", "helloWorld");
  console.log("ans: ", ans);
  */
  ...
  return (
    <div className="App">
      ...
      <Menu style={{ textAlign: "center", marginTop: 20 }} selectedKeys={[location.pathname]} mode="horizontal">
        ...
        <Menu.Item key="/hints">
          <Link to="/hints">Verify Artwork</Link>
        </Menu.Item>
        <Menu.Item key="/exampleui">
          <Link to="/exampleui">Upload Artwork</Link>
        </Menu.Item>
        <Menu.Item key="/subgraph">
          <Link to="/subgraph">All Artworks</Link>
        </Menu.Item>
      </Menu>
